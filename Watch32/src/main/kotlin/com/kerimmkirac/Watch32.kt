...
class Watch32 : MainAPI() {
    ...
    override val mainPage =
            mainPageOf(
                    ...
                    "$mainUrl/filter?type=tv&quality=all&release_year=all&genre=all&country=135page=" to "Kdrama",
                    "$mainUrl/filter?type=tv&quality=all&release_year=all&genre=all&country=173?page=" to "Jdrama",
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        val type = url
        val posterr = res.document.select("div.film-poster > img").attr("src")
