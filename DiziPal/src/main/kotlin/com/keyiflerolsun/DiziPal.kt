...
class DiziPal : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "${mainUrl}/diziler?kelime=&durum=&tur=28&type=&siralama=" to "Editörün Seçtiği Diziler",
        "${mainUrl}/tur/editorun-sectikleri"                       to "Editörün Seçtiği Filmler",
        ...
        // ! "${mainUrl}/diziler?kelime=&durum=&tur=27&siralama="       to "Mubi Dizileri", // İçerik yok - Mubi dizi yayınlamıyor!

        "${mainUrl}/diziler?kelime=&durum=&tur=1&type=&siralama="  to "Aile Dizileri",
        "${mainUrl}/tur/aile"                                      to "Aile Filmleri",
        "${mainUrl}/diziler?kelime=&durum=&tur=2&type=&siralama="  to "Aksiyon Dizileri",
        "${mainUrl}/tur/aksiyon"                                   to "Aksiyon Filmleri",
        "${mainUrl}/diziler?kelime=&durum=&tur=3&type=&siralama="  to "Animasyon Dizileri",
        "${mainUrl}/tur/animasyon"                                 to "Animasyon Filmleri",
        "${mainUrl}/diziler?kelime=&durum=&tur=26&type=&siralama=" to "Anime Dizileri",
        "${mainUrl}/tur/anime"                                     to "Anime Filmleri",
        ...
        "${mainUrl}/diziler?kelime=&durum=&tur=6&type=&siralama="  to "Biyografi Dizileri",
        "${mainUrl}/tur/biyografi"                                 to "Biyografi Filmleri",
        "${mainUrl}/diziler?kelime=&durum=&tur=7&type=&siralama="  to "Dram Dizileri",
        ...
        "${mainUrl}/diziler?kelime=&durum=&tur=8&type=&siralama="  to "Fantastik Dizileri",
        "${mainUrl}/tur/fantastik"                                 to "Fantastik Filmleri",
        "${mainUrl}/diziler?kelime=&durum=&tur=9&type=&siralama="  to "Gerilim Dizileri",
        "${mainUrl}/tur/gerilim"                                   to "Gerilim Filmleri",
        "${mainUrl}/diziler?kelime=&durum=&tur=10&type=&siralama=" to "Gizem Dizileri",
        ...
        "${mainUrl}/diziler?kelime=&durum=&tur=12&type=&siralama=" to "Korku Dizileri",
        "${mainUrl}/tur/korku"                                     to "Korku Filmleri",
        "${mainUrl}/diziler?kelime=&durum=&tur=13&type=&siralama=" to "Macera Dizileri",
        "${mainUrl}/tur/macera"                                    to "Macera Filmleri",
        "${mainUrl}/diziler?kelime=&durum=&tur=14&type=&siralama=" to "Müzik Dizileri",
        "${mainUrl}/tur/muzik"                                     to "Müzik Filmleri",
        "${mainUrl}/diziler?kelime=&durum=&tur=16&type=&siralama=" to "Romantik Dizileri",
        "${mainUrl}/tur/romantik"                                  to "Romantik Filmleri",
        "${mainUrl}/diziler?kelime=&durum=&tur=17&type=&siralama=" to "Savaş Dizileri",
        "${mainUrl}/tur/savas"                                     to "Savaş Filmleri",
        "${mainUrl}/diziler?kelime=&durum=&tur=18&type=&siralama=" to "Spor Dizileri",
        "${mainUrl}/tur/spor"                                      to "Spor Filmleri",
        "${mainUrl}/diziler?kelime=&durum=&tur=19&type=&siralama=" to "Suç Dizileri",
        "${mainUrl}/tur/suc"                                       to "Suç Filmleri",
        "${mainUrl}/diziler?kelime=&durum=&tur=20&type=&siralama=" to "Tarih Dizileri",
        "${mainUrl}/tur/tarih"                                     to "Tarih Filmleri",
        "${mainUrl}/diziler?kelime=&durum=&tur=21&type=&siralama=" to "Western Dizileri",
        "${mainUrl}/tur/western"                                   to "Western Filmleri",
        "${mainUrl}/diziler?kelime=&durum=&tur=24&type=&siralama=" to "Yerli Diziler",
        "${mainUrl}/tur/yerli"                                     to "Yerli Filmleri",
        // ! Fazla kategori olduğu için geç yükleniyor..
    )
    ...
    override suspend fun load(url: String): LoadResponse? {
        ...
        val rating      = document.selectXpath("//div[text()='IMDB Puanı']//following-sibling::div").text().trim().toIntOrNull()
