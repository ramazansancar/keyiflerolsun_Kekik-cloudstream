...
//        "10"   to   "Tarih Dizi",
    ...
    private suspend fun initSession() {
        ...
        initMutex.withLock {
            ...
            Log.d("kerimmkirac_$name", "🔄 Oturum başlatılıyor: cookie ve cKey/cValue alınıyor")
            ...
            Log.d("kerimmkirac_$name", "✅ Cookie sayısı: ${sessionCookies?.size}, cKey: $cKeyToken, cValue: $cValueToken")
        }
    }
...
//        Log.d("kerimmkirac_$name","htmlString = $htmlString")

        val doc: Document = Jsoup.parse(htmlString)


//        Log.d("kerimmkirac_$name","doc = $doc")
...
class CloudflareInterceptor(private val cloudflareKiller: CloudflareKiller): Interceptor {
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (doc.html().contains("Just a moment") || doc.html().contains("verifying")) {
            Log.d("kerimmkirac_Unutulmaz", "!!cloudflare geldi!!")
