...
class AnimeciX : MainAPI() {
    ...
    override suspend fun loadLinks(
        ...
        Log.d("kerimmkirac_ACX", "data » $data")
        ...
        Log.d("kerimmkirac_ACX", "Final iframeLink » $iframeLink")
        ...
        if (iframeLink.contains("anm.cx")) {
            val rawJson = app
                ...
                .body
                .string()
            Log.d("kerimmkirac_ACX", "rawJson =  $rawJson")
            ...
            for (i in 0 until videosArray.length()) {
                ...
                Log.d("kerimmkirac_ACX", "Video URL: $url")
            ...
            for (video in videos) {
                ...
                if (listOf("tau-video", "sibnet").any { video.url.contains(it) }) {
                    Log.d("kerimmkirac_ACX", "liste  =  $requestData")
                    loadExtractor(
                        requestData,
                        "${mainUrl}/",
                        subtitleCallback,
                    ...
                    Log.d("kerimmkirac_ACX", "else url  =  ${video.url}")
