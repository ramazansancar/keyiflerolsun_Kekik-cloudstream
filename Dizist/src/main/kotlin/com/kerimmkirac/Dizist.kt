...
//            Log.d("kerimmkirac_Dizist", "🔄 Oturum başlatılıyor: cookie, cKey ve cValue alınıyor")
            ...
            Log.d("kerimmkirac_Dizist", "cKey: $cKey, cValue: ${cValue}")
        }
    }
...
//        Log.d("kerimmkirac_Dizist", "neden bos ${document.select("div.poster-xs")}")
...
//        Log.d("kerimmkirac_$name", "title = ${title}")
        val href = fixUrlNull(a.attr("href")) ?: return null
//        Log.d("kerimmkirac_$name", "href = ${href}")
        val poster = a.selectFirst("img")?.attr("data-srcset")
            ?.substringBefore(" 1x")
            ?.trim()
            ?.let { fixUrlNull(it) }
//        Log.d("kerimmkirac_$name", "poster = ${poster}")
...
//        Log.d("kerimmkirac_$name", "Bulunan kaynak sayısı: ${kaynakLinkleri.size}")
        ...
        kaynakLinkleri.forEach { linkElem ->
            ...
            Log.d("kerimmkirac_$name", "iframe = $iframeSrc")
