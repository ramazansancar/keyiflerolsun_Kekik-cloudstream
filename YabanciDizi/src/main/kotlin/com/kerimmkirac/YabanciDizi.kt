...
//                Log.d("kerimmkirac_$name","mac = $mac")
                val iDoc = app.get(
...
//                Log.d("kerimmkirac_$name","decryptedData = $decryptedData")
                ...
                Log.d("kerimmkirac_$name","urlList = $urlList")
                for (sonUrl in urlList) {
                    Log.d("kerimmkirac_$name", "sonUrl: ${sonUrl.link} -- ${sonUrl.resolution}")
                    callback.invoke(
                        newExtractorLink(
